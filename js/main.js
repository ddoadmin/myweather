...
//weatherConditions.onerror = _handleError;
//weatherConditions.onload = _handleLoad;

var weatherForecast = new XMLHttpRequest();
//weatherForecast.onerror = _handleError;
//weatherForecast.onload = _handleLoad;

var cObj;
var fObj;

function loadWeather () {
// this is coming from index.html zip input id.
	var zip = document.getElementById('zip').value;
	if (zip === '')	{zip = "08854"}; // zip code for piscataway is 08854
//	var zip ="07306"
    var conditionsPath = "http://api.wunderground.com/api/deb894c07f0afef7/conditions/q/"+zip+".json";
    var forecastPath = "http://api.wunderground.com/api/deb894c07f0afef7/forecast/q/"+zip+".json";
